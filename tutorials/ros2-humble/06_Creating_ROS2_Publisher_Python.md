...
[← Back to Contents](00_Contents.md) | [← Previous: Chapter 5.1 — Creating a ROS2 Publisher (C++)](05_Creating_ROS2_Publisher_Cpp.md) | [Next: Chapter 6.1 — Configuring Packages (C++) →](07_Configuring_Packages_Cpp.md)
...
9. To see the messages published by our **publisher.py** file’s **hello_world** topic, use the following command in the **2nd terminal**:
    ...
    ![Untitled](images/image30.png)
    

![Untitled](images/image31.png)
