# Chapter 6 — Creating ROS2 Publisher (Python)

[← Back to Contents](00_Contents.md) | [← Previous Lesson: Chapter 5 — Creating ROS2 Publisher (C++)](05_Creating_ROS2_Publisher_Cpp.md) | [Next Lesson: Chapter 7 — Configuring Packages (C++) →](07_Configuring_Packages_Cpp.md)
...
2. In the VS Code File Explorer Panel on the left, under the **source directory (src)** → **udemy_ros2_pkg** package folder → **scripts** folder **→** Create a **new file** named **publisher.py.**
...
5. You can run this file from your **VS Code** in two ways (_your VS Code must be opened from your **workspace folder**_)
    1. Using the **Run Python File Button** at the top-right corner of your VS Code window.

        ![Figure 1 — Creating ROS2 Publisher (Python)](images/image32.png)
    ...
    2. Using **VS Code Integrated Terminal** *(or **any other** terminal)*
        ...
        ![Figure 2 — Creating ROS2 Publisher (Python)](images/image33.png)
...
7. To get the list of **currently active nodes** use the following command in the **2nd terminal**:
    ...
    ![Figure 3 — Creating ROS2 Publisher (Python)](images/image28.png)

    As we can see the name of our **publisher.py** file’s **node** name **hello_world_pub_node** in the list of the **currently active nodes** - this proves that our file **publisher.py** is running successfully.
...
8. To get the list of **currently active topics** use the following command in the **2nd terminal**:
    ...
    ![Figure 4 — Creating ROS2 Publisher (Python)](images/image29.png)
...
9. To see the messages published by our **publisher.py** file’s **hello_world** topic, use the following command in the **2nd terminal**:
    ...
    ![Figure 5 — Creating ROS2 Publisher (Python)](images/image30.png)


![Figure 6 — Creating ROS2 Publisher (Python)](images/image31.png)
