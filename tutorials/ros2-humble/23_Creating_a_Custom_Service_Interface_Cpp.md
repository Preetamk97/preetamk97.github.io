# Chapter 23 — Creating a Custom Service Interface (C++)

[← Back to Contents](00_Contents.md) | [← Previous Lesson: Chapter 22 — Project 2 — Launch Files (Python)](22_Project_Launch_Files_Python.md) | [Next Lesson: Chapter 24 — Creating a Service Client (C++) →](24_Creating_a_Service_Client_Cpp.md)
...
2. To see the details/content of any interface, run the following bash command:
    ...
    Example: Let us check the details/content of **std_srvs/srv/SetBool** service interface.

    ![Figure 1 — Creating a Custom Service Interface (C++)](images/image133.png)
...
![Figure 2 — Creating a Custom Service Interface (C++)](images/image134.png)
...
![Figure 3 — Creating a Custom Service Interface (C++)](images/image135.png)
...
![Figure 4 — Creating a Custom Service Interface (C++)](images/image136.png)
