# Chapter 19 — Launch Files (C++)

[← Back to Contents](00_Contents.md) | [← Previous Lesson: Chapter 18 — ROS2 Parameters (Python)](18_ROS2_Parameters_Python.md) | [Next Lesson: Chapter 20 — Launch Files (Python) →](20_Launch_Files_Python.md)
...
2. Create a **new folder** named **launch** inside your **udemy_ros2_pkg** package folder.
    ...
    ![Figure 1 — Launch Files (C++)](images/image121.png)
...
3. **Right-click** on **launch → New File** → Name it **rpm_pub_node_launch.py** — this is a **python file** and inside this file, we are gonna add some **python code.**
    ...
    ![Figure 2 — Launch Files (C++)](images/image122.png)
...
8. To run the **launch file** from the **terminal →** Open a new terminal in the **workspace** folder and run the following **bash commands:**
    ...
    ![Figure 3 — Launch Files (C++)](images/image123.png)

    Observe the highlighted portion of the output below:

    ![Figure 4 — Launch Files (C++)](images/image124.png)

    You can see the **outputs** for the `ros2 node list` and `ros2 topic list` commands in the **terminal output**.
...
9. To check if our **rpm_publisher** node is running properly - run the following commands from a **new terminal:**
    ...
    ![Figure 5 — Launch Files (C++)](images/image125.png)
