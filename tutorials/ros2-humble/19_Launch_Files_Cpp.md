...
[← Back to Contents](00_Contents.md) | [← Previous: Chapter 11.2 — ROS2 Parameters (Python)](18_ROS2_Parameters_Python.md) | [Next: Chapter 12.2 — Launch Files (Python) →](20_Launch_Files_Python.md)
...
8. To run the **launch file** from the **terminal →** Open a new terminal in the **workspace** folder and run the following **bash commands:**
    ...
    ![Untitled](images/image123.png)
    
    Observe the highlighted portion of the output below:
    
    ![Untitled](images/image124.png)
