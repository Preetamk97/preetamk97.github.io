...
[← Back to Contents](00_Contents.md) | [← Previous: Chapter 15 — Creating a Service Server (C++)](25_Creating_a_Service_Server_Cpp.md) | [Next: Project 3.1 — Using OpenCV with ROS2 Services (C++) →](27_Project_Using_OpenCV_with_ROS2_Services_Cpp.md)
...
- Now open a new terminal in the workspace folder and run the following commands.
    ...
    ![Untitled](images/image148.png)
    
    ![Untitled](images/image149.png)
...
- We can interact with our **service_server.py** node even without having a service client node yet.
    ...
    ![Untitled](images/image153.png)
    
    ![Untitled](images/image154.png)
