...
- Open a **new terminal in VS Code** and the following command:
    ...
    ![*picture source:* [https://answers.ros.org/question/407132/ros2-node-list-crash-xmlrpcclientfault/](https://answers.ros.org/question/407132/ros2-node-list-crash-xmlrpcclientfault/)](images/image41.png)
...
![Untitled](images/image42.png)

![Untitled](images/image43.png)
...
![Untitled](images/image45.png)

![Untitled](images/image46.png)
...
![Untitled](images/image48.png)

![Untitled](images/image49.png)
...
- We can also see the same for **debug_ws/install/udemy_ros2_pkg/lib/udemy_ros2_pkg/publisher** file and **debug_ws/build/udemy_ros2_pkg/publisher** file.
    ...
    ![Untitled](images/image50.png)
    
    ![Untitled](images/image51.png)
...
- **For checking the location of the main source file**, we can use the `readlink file_name` command **on terminal** — **from the location of the symbolic link file** — that should be somewhere in the **install** directory.
    ...
    ![Untitled](images/image52.png)
    
    ![Untitled](images/image53.png)
...
- Now click on **Terminal → Run Build Task**
    ...
    ![Untitled](images/image55.png)
    
    or,
    
    click on **Terminal → Run Task →** choose **build**
    
    ![Untitled](images/image56.png)
    
    ![Untitled](images/image57.png)
