# Chapter 28 — Project 3 — Using OpenCV with ROS2 Services (Python)

[← Back to Contents](00_Contents.md) | [← Previous Lesson: Chapter 27 — Project 3 — Using OpenCV with ROS2 Services (C++)](27_Project_Using_OpenCV_with_ROS2_Services_Cpp.md) | [Next Lesson: Chapter 29 — ROS2 Actions (Python) →](29_ROS2_Actions_Python.md)
...
- To check if **OpenCV** is installed properly in your Ubuntu System, run the following commands from the same terminal.
    ...
    ![Figure 1 — Project 3 — Using OpenCV with ROS2 Services (Python)](images/image163.png)
...
- Another way to check **OpenCV** Version is to run the following command from the terminal:
    ...
    ![Figure 2 — Project 3 — Using OpenCV with ROS2 Services (Python)](images/image162.png)
...
![Figure 3 — Project 3 — Using OpenCV with ROS2 Services (Python)](images/image164.png)
