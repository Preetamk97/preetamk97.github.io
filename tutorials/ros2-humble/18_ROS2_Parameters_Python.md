# Chapter 18 — ROS2 Parameters (Python)

[← Back to Contents](00_Contents.md) | [← Previous Lesson: Chapter 17 — ROS2 Parameters (C++)](17_ROS2_Parameters_Cpp.md) | [Next Lesson: Chapter 19 — Launch Files (C++) →](19_Launch_Files_Cpp.md)
...
1. Open a **new terminal** in the **workspace** folder → Run the **rpm_publisher.py** code using the below command.
    ...
    ![Figure 1 — ROS2 Parameters (Python)](images/image114.png)
...
2. Open a **new terminal** in the **workspace** folder → Run the **rpm_subscriber.py** code using the below command.
    ...
    ![Figure 2 — ROS2 Parameters (Python)](images/image115.png)

3. Open a **new terminal** and run the below command.
    ...
    ![Figure 3 — ROS2 Parameters (Python)](images/image116.png)

4. **To see the value of a parameter** run the following command from the **same terminal**:
    ...
    ![Figure 4 — ROS2 Parameters (Python)](images/image117.png)
...
5. If you want to see more information about a parameter, use the following command from the **same terminal**:
    ...
    ![Figure 5 — ROS2 Parameters (Python)](images/image118.png)


![Figure 6 — ROS2 Parameters (Python)](images/image119.png)
...
4. Open a **new terminal** and run the following commands:
    ...
    ![Figure 7 — ROS2 Parameters (Python)](images/image120.png)

    ![Figure 8 — ROS2 Parameters (Python)](images/image113.png)
