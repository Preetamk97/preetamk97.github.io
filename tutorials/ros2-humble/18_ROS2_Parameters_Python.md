...
[← Back to Contents](00_Contents.md) | [← Previous: Chapter 11.1 — ROS2 Parameters (C++)](17_ROS2_Parameters_Cpp.md) | [Next: Chapter 12.1 — Launch Files (C++) →](19_Launch_Files_Cpp.md)
...
1. If you want to see more information about a parameter, use the following command from the **same terminal**:
    ...
    **ros2 param describe /rpm_pub_node use_sim_time**
    ...
    ![Untitled](images/image118.png)
    

![Untitled](images/image119.png)
...
4. Open a **new terminal** and run the following commands**:**
    ...
    ![Untitled](images/image120.png)
    
    ![Untitled](images/image113.png)
