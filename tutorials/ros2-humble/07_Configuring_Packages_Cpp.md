...
ros2 topic list -t
# Gives list of active topics alongwith the datatype of the messages being published.
...
ros2 topic info /hello_world --verbose
ros2 topic hz /hello_world
```
