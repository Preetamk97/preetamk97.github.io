# Chapter 14 — ROS2 Interface Types

[← Back to Contents](00_Contents.md) | [← Previous Lesson: Chapter 13 — ROS2 Logging (C++)](13_ROS2_Logging_Cpp.md) | [Next Lesson: Chapter 15 — Project 1 — Publishers & Subscribers (C++) →](15_Project_Publishers_and_Subscribers_Cpp.md)
...
1. **Message Interfaces** - Stored in `/msg` folders. Message Interfaces are **C++ struct data structures** that are **used to represent and exchange data between nodes in a ROS2 system**. Each field in the struct typically corresponds to a different data type, such as int32, float32, or std::string.
    ...
    - `std_msgs/msg`: This folder contains **message interfaces** for representing various **primitive data types**, such as **strings**, **integers,** and **floating-point numbers**. Some examples of interfaces contained in this folder include:
        ...
        ![Basic primitive datatypes in ROS2 and their C++ and Python equivalents](images/image105.png)

        ***A list of basic primitive datatypes in ROS2 and their corresponding names in the C++ and Python languages.***
        Source — ROS2 Foxy official documentation ([docs.ros.org — About ROS Interfaces](https://docs.ros.org/en/foxy/Concepts/About-ROS-Interfaces.html))
