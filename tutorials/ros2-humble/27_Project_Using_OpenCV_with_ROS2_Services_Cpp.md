# Chapter 27 — Project 3 — Using OpenCV with ROS2 Services (C++)

[← Back to Contents](00_Contents.md) | [← Previous Lesson: Chapter 26 — Creating Services (Python)](26_Creating_Services_Python.md) | [Next Lesson: Chapter 28 — Project 3 — Using OpenCV with ROS2 Services (Python) →](28_Project_Using_OpenCV_with_ROS2_Services_Python.md)
...
## Step 1. Installing OpenCV and CVBridge
...
- To check if **OpenCV** is installed properly in your Ubuntu System, run the following commands from the same terminal.
    ...
    ![Figure 1 — Project 3 — Using OpenCV with ROS2 Services (C++)](images/image160.png)
...
- Another way to check **OpenCV** Version is to run the following command from the terminal:
    ...
    ![Figure 2 — Project 3 — Using OpenCV with ROS2 Services (C++)](images/image161.png)
