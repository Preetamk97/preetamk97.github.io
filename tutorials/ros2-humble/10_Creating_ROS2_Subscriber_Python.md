...
[← Back to Contents](00_Contents.md) | [← Previous: Chapter 8.1 — Creating a ROS2 Subscriber (C++)](09_Creating_ROS2_Subscriber_Cpp.md) | [Next: Chapter 8.3 — Configuring Packages (Python) →](11_Configuring_Packages_Python.md)
...
- As of now, our **subscriber.py** script is ***succesfully running*** and the node **hello_world_sub_node** is ****listening for any messages over the topic **hello_world.**
    ...
    ![*(Opened a new terminal and ran the command `ros2 node list` to check if **hello_world_sub_node** is up and active)*](images/image69.png)
